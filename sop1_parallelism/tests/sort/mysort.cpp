...
class SortMR : public MapReduceSort<SortMR, sort_string, sort_word, uint64_t, fixed_hash_container<sort_word, uint64_t, sum_combiner, 32768, sort_word_hash
#else
class SortMR : public MapReduceSort<SortMR, sort_string, sort_word, uint64_t, hash_container<sort_word, uint64_t, sum_combiner, sort_word_hash 
#endif
#ifdef TBB
...
//class SortMR : public MapReduceSort<SortMR, sort_string, sort_string, sort_string, hash_container<sort_string, sort_string, buffer_combiner, sort_word_hash> > {
	char* data;
	uint64_t data_size;
	uint64_t chunk_size;
